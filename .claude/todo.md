...
更新：2026-05-01（補晉書藝文志修復 + 直齋書錄解題部分條目）
...
| 直齋書錄解題（部分） | 1ev3bb403quio | 296* | 13類 | 2026-05-01 |
...
- **卷數**：22卷（下載成功 20 卷，21-22 卷 404）
- **條目數**：約3,039條（已處理 296 條）
- **已完成卷**：卷1-20 的部分卷（卷1: 35, 卷4: 25, 卷5: 5, 卷7: 207, 卷8: 13, 卷10: 10, 卷15: 1）
- **已生成 Work**：183 個新建 + 113 個匹配現有
- **已生成 CE 類目**：13 個
- **待處理**：卷2, 3, 6, 9, 11-14, 16-20 的書名行缺失，需調查 wiki 格式差異
- **狀態**：⏳ 部分完成（296/3039）
