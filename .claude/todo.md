...
更新：2026-08-08（殘名撰人修復完成大半 / PR #17 待合併）
...
**修復狀態**：🔄 本地已修復約 151/169 條 Work，尚未 commit/push
...
| batch3 | 乙類中置信25條 | 37 | 25 | 范→范寧/崔→崔譔；肇→僧肇/影→曇影/遠→慧遠（佛教）；伏→伏滔/戴→戴祚；蔡→蔡謨/謝→謝沈/毓→氾毓/純→荀綽/護→晏謨 等 |
...
- **擴展：二字殘名普查（本清單 169 條之外的新發現）**：2026-08-08 另修復 66 Work（見「二字殘名普查修復」章節）

**剩餘工作**：
- [ ] 本地 commit（batch4 82 檔案 + 二字殘名 66 檔案，合計 161 files changed）
