...
| `adapted_from` | — | 改編自 |
| `same_title_source` | —（單向，可互寫） | **同題而撰人異，本庫不代諸家決其是非者**。志書於一題之下著錄互異之撰人（或一書而數家異說），依〈同題異撰是二書〉各以其撰人立條，再以本詞互相指明「彼條與我同題而所著撰人異」。<br>**不是「同一部書」之斷言**——正相反，它記的是「本庫存疑而各存其目」。欲併須有外證。<br>無反向詞；兩側各寫一條即為互指，不強求成對。 |
